...
<header>
	<div id="header" class="block-full">
		...
		<h1 class="header-logo">ブランド品・宝石・ブランド腕時計の高価買取
			<img src="<?php echo get_template_directory_uri() ?>/common/images/common/img_logo.png" alt="ウレル ロゴ" title="ウレル ロゴ"></h1>
		<?php else : ?>
		<div class="header-logo">ブランド品・宝石・ブランド腕時計の高価買取
			<img src="<?php echo get_template_directory_uri() ?>/common/images/common/img_logo.png" alt="ウレル ロゴ" title="ウレル ロゴ"></div>
		<?php endif; ?>
	</div>
